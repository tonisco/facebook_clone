...
const Posts = () => {
	return (
		<main className="w-full md:w-[50%] my-3 bg-white w-2xl  shadow-lg text-gray-900">
				...
				<div className="flex items-center w-auto mr-auto">
					<div className="relative flex">
						<figure className="reaction-icon h-6 w-6 ">
							<Image src="/images/reaction/like.svg" alt="reaction" layout="fill" />
						</figure>
						<figure className="reaction-icon h-6 w-6 -translate-x-1/4">
							<Image src="/images/reaction/haha.svg" alt="reaction" layout="fill" />
						</figure>
						<figure className="reaction-icon h-6 w-6 -translate-x-1/2">
							<Image src="/images/reaction/love.svg" alt="reaction" layout="fill" />
						</figure>
						<figure className="reaction-icon h-6 w-6 -translate-x-3/4">
							<Image src="/images/reaction/sad.svg" alt="reaction" layout="fill" />
						</figure>
					</div>
