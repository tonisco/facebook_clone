...
const Stories = () => {
	...
	return (
		<div className="flex gap-4 py-5 w-full overflow-x-scroll max-w-2xl scrollbar-thin scrollbar-thumb-gray-900 ">
			{users.length > 0 && (
				<div className=" relative h-48 w-32 flex-shrink-0 flex flex-col justify-between rounded-xl overflow-hidden shadow-xl cursor-pointer bg-white">
					...
					<div className="absolute bottom-7 left-11 bg-white rounded-full">
